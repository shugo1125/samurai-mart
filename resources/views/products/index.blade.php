...
<div class="row">
  ...
  <div class="col-9">
    ...
    <div>
      ...
      @endphp
      <a href="{{ route('products.index', ['sort' => 'id', 'order' => $currentSort === 'id' ? $newOrder : 'desc']) }}">ID</a>
      <a href="{{ route('products.index', ['sort' => 'price', 'order' => $currentSort === 'price' ? $newOrder : 'desc']) }}">Price</a>
      <a href="{{ route('products.index', ['sort' => 'created_at', 'order' => $currentSort === 'created_at' ? $newOrder : 'desc']) }}">Created At</a>
    </div>
