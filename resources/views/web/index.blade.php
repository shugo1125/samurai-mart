...
<div class="row">
  ...
  <div class="col-9">
        ...
        <div class="row">
          <div class="col-12">
            <p class="samuraimart-product-label mt-2">
              ...
              <span>
                @php
                $fullStars = floor($recommend_product->getAverageScore());
                $halfStar = ($recommend_product->getAverageScore() - $fullStars) >= 0.5 ? 1 : 0;
                ...
                @for ($i = 0; $i < $fullStars; $i++)
                  ...
                  @for ($i = 0; $i < $halfStar; $i++)
                    ...
                    @for ($i = 0; $i < $emptyStars; $i++)
                      ...
                      @endfor
                      {{ number_format($recommend_product->getAverageScore(), 1) }}
              </span>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1 class="new-products-title">新着商品</h1>
      <a href="{{ route('products.index' ,['sort' => 'id', 'order' => 'desc'])}}" class="more-link">もっと見る</a>
    </div>
    <div class="row">
        ...
        <div class="row">
          <div class="col-12">
            <p class="samuraimart-product-label mt-2">
              ...
              <span>
                @php
                $fullStars = floor($recently_product->getAverageScore());
                $halfStar = ($recently_product->getAverageScore() - $fullStars) >= 0.5 ? 1 : 0;
                $emptyStars = 5 - ($fullStars + $halfStar);
                @endphp
                ...
                @for ($i = 0; $i < $fullStars; $i++)
                  ...
                  @for ($i = 0; $i < $halfStar; $i++)
                    ...
                    @for ($i = 0; $i < $emptyStars; $i++)
                      <i class="far fa-star"></i>
                      @endfor
                      {{ number_format($recently_product->getAverageScore(), 1) }}
              </span>
